              ...
              <table class="table table-hover table-striped tablesorter">
                <thead>
                  <tr>
                    ...
                    <th>Nama Pengarang<i class="fa fa-sort"></i></th>
                ...
                <tbody>
                  ...
                  while($ambil=mysqli_fetch_array($query)) {
                   ...
                   <tr>
                     ...
                     <td>
                       <img width="200px" src="image/<?php echo $ambil['gambar'] ?>"><br>

                       <?php echo $ambil['gambar']; ?></td>

                     <td>
                       <a href="form_edit.php" class="btn btn-primary">Edit</a>
